...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if([item.type  isEqual: @"In Progress"])
        f= 44.0;
    else
        f=0.0;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([item.type  isEqual: @"In Progress"])
    {
        cell = [tableView dequeueReusableCellWithIdentifier:@"cell_inprogress" forIndexPath:indexPath];
        cell.textLabel.text=item.title;
        cell.imageView.image = [UIImage imageNamed:@"inprogress.png"];
    }
    else{
        cell = [tableView dequeueReusableCellWithIdentifier:@"cell_inprogress_empty" forIndexPath:indexPath];
        cell.hidden=YES;
    }
